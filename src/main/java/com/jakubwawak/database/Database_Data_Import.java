...
public class Database_Data_Import {
    ...
    public Database_Data_Import(Database_Connector database){
     ...
     * @throws SQLException 
     */
    public void import_workers(Data_Worker_Connector dwc) throws SQLException{
            ...
            try{
                for(ArrayList<String> data : dwc.lines){
                    ...
                    if ( database.get_worker_id_bypin(data.get(3)) != 1){
                        ...
                        ppst.setString(1,database.login_generator(data.get(0), data.get(1)));
